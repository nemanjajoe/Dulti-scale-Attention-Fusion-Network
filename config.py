...
DAFNet_synapse_version1_cls9_v13= {
  'describe'  : "Cascade Decoder", 
  'save_path' : 'D:\\Projects\\results\\DAFNet\\version1_cls_9_v13',
  'device'    : 'cuda:0' if torch.cuda.is_available() else 'cpu',
  'epoch_num' : 240,
  'num_classes': NCLS,
  'pretrained_params' : None,
...
DAFNet_synapse_version1_cls9_v14= {
  'describe'  : "MLP mixer: add GELU activation layer", 
  'save_path' : 'D:\\Projects\\results\\DAFNet\\version1_cls_9_v14',
  'device'    : 'cuda:0' if torch.cuda.is_available() else 'cpu',
  'epoch_num' : 240,
  'num_classes': NCLS,
  'pretrained_params' : None,
...
DAFNet_synapse_version1_cls9_v16= {
  'describe'  : "optimize first stage", 
  'save_path' : 'D:\\Projects\\results\\DAFNet\\version1_cls_9_v16',
  'device'    : 'cuda:0' if torch.cuda.is_available() else 'cpu',
  'epoch_num' : 240,
  'num_classes': NCLS,
  'pretrained_params' : None,
  'model'     : DAFN,
  'model_args': {'img_size':224, 'dim_in':1, 'dim_out':9, 'embed_dim':64,'depth':[1,2,4,2],
                 'split_size':[1,2,2,7], 'num_heads':[2,4,8,16],'qkv_bias':False, 'qk_scale':None,
                 },
  'criterion' : DiceLoss,
  'criterion_args': {'n_classes' : NCLS}, # number of classes should equal to the number of out channels in model_args
